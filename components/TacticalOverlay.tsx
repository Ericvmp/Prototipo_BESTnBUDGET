          ...
          >
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6 mb-8">
                ...
                >
                  <SmartItemIcon itemName={item.name} icon={item.icon || 'military_tech'} rarity={item.rarity} imageClassName="w-full h-full object-contain drop-shadow-[0_10px_20px_rgba(0,0,0,0.8)]" iconClassName="text-6xl" style={{ color: rarity.hex }} />
                </div>
