...
__export(data_exports, {
  AUGMENTS_DATA: () => AUGMENTS_DATA,
  LOOT_DATA: () => LOOT_DATA,
  MATERIALS_DATA: () => MATERIALS_DATA,
  MODS_DATA: () => MODS_DATA,
  THROWABLES_DATA: () => THROWABLES_DATA,
  WEAPONS_DATA: () => WEAPONS_DATA,
  WEAPON_MOD_SLOTS: () => WEAPON_MOD_SLOTS,
  WEAPON_SETUPS_DATA: () => WEAPON_SETUPS_DATA
});
...
var MATERIALS_DATA = [
  {
    ...
    rarity: "COMMON",
    icon: "construction",
    imageUrl: "/images/materials/Metal_Parts.png",
    craftInfo: { isCraftable: false, note: "Material b\xE1sico" },
    residualInfo: { items: ["Steel Spring \u2192 Metal Parts", "Simple Gun Parts \u2192 2\xD7 Metal Parts", "Magnet \u2192 3\xD7 Metal Parts"] },
  ...
  },
  {
    ...
    imageUrl: "/images/materials/Rubber_Parts.png",
    craftInfo: { isCraftable: false, note: "Material b\xE1sico" },
    residualInfo: { items: ["Wires \u2192 2\xD7 Rubber Parts", "ARC Flex Rubber", "Mechanical Components \u2192 2\xD7 Rubber Parts"] },
  ...
  },
  {
    ...
    rarity: "COMMON",
    icon: "inventory_2",
    imageUrl: "/images/materials/Plastic_Parts.png",
    craftInfo: { isCraftable: false, note: "Material b\xE1sico" },
    residualInfo: { items: ["Diversos itens de lixo pl\xE1stico"] },
  ...
  },
  {
    ...
    rarity: "UNCOMMON",
    icon: "settings",
    imageUrl: "/images/materials/Mechanical_Components.png",
    craftInfo: {
      isCraftable: true,
      location: "Refiner 1",
      requirements: [{
  ...
  },
  {
    id: "mat5",
    name: "Mod Components",
    recycleInfo: [{ name: "Mechanical Components", stackSize: 10, quantity: 1 }, {
      name: "Steel Spring",
      purchasableFromCeleste: true,
      stackSize: 15,
      quantity: 1
    }],
    salvageInfo: [{ name: "Mechanical Components", stackSize: 10, quantity: 1 }],
    stackSize: 5,
    ...
    rarity: "RARE",
    icon: "extension",
    imageUrl: "/images/materials/Mod_Components.png",
    craftInfo: {
      isCraftable: true,
      location: "Refiner 2",
      requirements: [{
  ...
  },
  {
    ...
    rarity: "COMMON",
    icon: "reorder",
    imageUrl: "/images/materials/Steel_Spring.png",
  ...
  },
  {
    ...
    rarity: "UNCOMMON",
    icon: "cable",
    imageUrl: "/images/materials/Wires.png",
    craftInfo: { isCraftable: false },
    residualInfo: {
      items: [
  ...
  },
  {
    ...
    rarity: "UNCOMMON",
    icon: "view_agenda",
    imageUrl: "/images/materials/Duct_Tape.png",
    craftInfo: { isCraftable: false },
    residualInfo: {
      items: [
  ...
  },
  {
    ...
    rarity: "UNCOMMON",
    icon: "hardware",
    imageUrl: "/images/materials/Simple_Gun_Parts.png",
    craftInfo: { isCraftable: false },
    residualInfo: {
      items: [
  ...
  },
  {
    ...
    imageUrl: "/images/materials/Light_Gun_Parts.png",
    craftInfo: {
      isCraftable: true,
      location: "Refiner 2",
      requirements: [{
  ...
  },
  {
    ...
    rarity: "RARE",
    icon: "precision_manufacturing",
    imageUrl: "/images/materials/Medium_Gun_Parts.png",
    craftInfo: {
      isCraftable: true,
      location: "Refiner 2",
      requirements: [{
    ...
    residualInfo: { items: ["Armas m\xE9dias (Renegade, Venator, Torrente)"] },
  ...
  },
  {
    ...
    rarity: "RARE",
    icon: "precision_manufacturing",
    imageUrl: "/images/materials/Heavy_Gun_Parts.png",
    craftInfo: {
      isCraftable: true,
      location: "Refiner 2",
      requirements: [{
  ...
  },
  {
    ...
    recycleInfo: [{
      ...
      stackSize: 15,
      quantity: 1
    }, { name: "Mechanical Components", stackSize: 10, quantity: 1 }],
    salvageInfo: [{ name: "Mechanical Components", stackSize: 10, quantity: 1 }],
    stackSize: 5,
    ...
    imageUrl: "/images/materials/Advanced_Mechanical_Components.png",
    craftInfo: {
      isCraftable: true,
      location: "Refiner 2",
      requirements: [{
  ...
  },
  {
    ...
    rarity: "UNCOMMON",
    icon: "u_turn_right",
    imageUrl: "/images/materials/Magnet.png",
    craftInfo: { isCraftable: false },
    residualInfo: {
      items: [
  ...
  },
  {
    ...
    rarity: "UNCOMMON",
    icon: "token",
    imageUrl: "/images/loot/ARC_Alloy.png",
  ...
  },
  {
    ...
    imageUrl: "/images/loot/ARC_Powercell.png",
  ...
  {
    id: "mat17",
    name: "Adv ARC Powercell",
    recycleInfo: [{ name: "ARC Powercell", stackSize: 5, quantity: 2 }],
    salvageInfo: [{ name: "ARC Powercell", stackSize: 5, quantity: 1 }],
    stackSize: 5,
    rarity: "RARE",
    icon: "battery_saver",
    imageUrl: "/images/materials/Advanced_ARC_Powercell.png",
  ...
  },
  {
    ...
    rarity: "UNCOMMON",
    icon: "memory",
    imageUrl: "/images/loot/Electrical_Components.png",
  ...
  },
  {
    ...
    recycleInfo: [{
      ...
      stackSize: 15,
      quantity: 1
    }, { name: "Electrical Components", stackSize: 10, quantity: 1 }],
    salvageInfo: [{ name: "Electrical Components", stackSize: 10, quantity: 1 }],
    stackSize: 5,
    rarity: "RARE",
    icon: "developer_board",
    imageUrl: "/images/loot/Advanced_Electrical_Components.png",
  ...
  },
  {
    id: "mat20",
    name: "ARC Circuitry",
    recycleInfo: [{ name: "ARC Alloy", stackSize: 15, quantity: 2 }],
    salvageInfo: [{ name: "ARC Alloy", stackSize: 15, quantity: 1 }],
    stackSize: 5,
    rarity: "RARE",
    icon: "circuit",
    imageUrl: "/images/loot/ARC_Circuitry.png",
  ...
  },
  {
    ...
    imageUrl: "/images/loot/ARC_Motion_Core.png",
  ...
  },
  {
    ...
    rarity: "UNCOMMON",
    icon: "sanitizer",
    imageUrl: "/images/materials/Antiseptic.png",
  ...
  },
  {
    ...
    imageUrl: "/images/materials/Canister.png",
  ...
  },
  {
    ...
    recycleInfo: [{
      ...
      stackSize: 50,
      quantity: 2
    }, { name: "ARC Alloy", stackSize: 15, quantity: 2 }],
    salvageInfo: [{ name: "ARC Alloy", stackSize: 15, quantity: 1 }],
    stackSize: 3,
    rarity: "RARE",
    icon: "pest_control",
    imageUrl: "/images/materials/Tick_Pod.png",
  ...
  },
  {
    ...
    rarity: "COMMON",
    icon: "texture",
    imageUrl: "/images/materials/Fabric.png",
  ...
  },
  {
    ...
    rarity: "UNCOMMON",
    icon: "layers",
    imageUrl: "/images/materials/Durable_Cloth.png",
  ...
  },
  {
    ...
    name: "Great Mullein",
    purchasableFromCeleste: true,
    recycleInfo: [{ name: "Assorted Seeds", stackSize: 100, quantity: 2 }],
    salvageInfo: [{ name: "Assorted Seeds", stackSize: 100, quantity: 1 }],
    stackSize: 15,
    rarity: "UNCOMMON",
    icon: "eco",
    imageUrl: "/images/materials/Great_Mullein.png",
  ...
  },
  {
    ...
    name: "Moss",
    purchasableFromCeleste: true,
    recycleInfo: [{ name: "Assorted Seeds", stackSize: 100, quantity: 3 }],
    salvageInfo: [{ name: "Assorted Seeds", stackSize: 100, quantity: 2 }],
    stackSize: 10,
    rarity: "RARE",
    icon: "grass",
    imageUrl: "/images/materials/Moss.png",
  ...
  },
  {
    ...
    rarity: "UNCOMMON",
    icon: "battery_full",
    imageUrl: "/images/materials/Battery.png",
  ...
  },
  {
    id: "mat31",
    name: "Power Rod",
    recycleInfo: [{ name: "Adv Electrical Components", stackSize: 5, quantity: 1 }, { name: "ARC Circuitry", stackSize: 5, quantity: 1 }],
    salvageInfo: [{ name: "Adv Electrical Components", stackSize: 5, quantity: 1 }],
    stackSize: 3,
    rarity: "RARE",
    icon: "vertical_align_center",
    imageUrl: "/images/loot/Power_Rod.png",
  ...
  },
  {
    ...
    rarity: "RARE",
    icon: "vaccines",
    imageUrl: "/images/materials/Syringe.png",
  ...
  },
  {
    ...
    imageUrl: "/images/materials/Voltage_Converter.png",
  ...
  },
  {
    ...
    craftInfo: { isCraftable: true, location: "Refiner 3", requirements: [{
      name: "Light Gun Parts",
      purchasableFromCeleste: true,
      stackSize: 5,
      quantity: 2
  ...
  },
  {
    ...
    recycleInfo: [{ name: "Adv Mechanical Components", stackSize: 5, quantity: 1 }, { name: "ARC Motion Core", stackSize: 5, quantity: 1 }],
    salvageInfo: [{ name: "Adv Mechanical Components", stackSize: 5, quantity: 1 }],
    stackSize: 3,
    rarity: "EPIC",
    icon: "all_inclusive",
    imageUrl: "/images/materials/Light_Gun_Parts.png",
  ...
  },
  {
    ...
    rarity: "RARE",
    icon: "memory",
    imageUrl: "/images/materials/Processor.png",
  ...
  },
  {
    ...
    imageUrl: "/images/loot/Exodus_Modules.png",
  ...
  },
  {
    ...
    rarity: "UNCOMMON",
    icon: "bomb",
    imageUrl: "https://arcraiders.wiki/w/images/e/e0/Crude_Explosives.png",
  ...
  },
  {
    ...
    rarity: "RARE",
    icon: "volcano",
    imageUrl: "/images/materials/Explosive_Compound.png",
  ...
  },
  {
    ...
    imageUrl: "/images/materials/Synthesized_Fuel.png",
  ...
  },
  {
    ...
    rarity: "RARE",
    icon: "fireplace",
    imageUrl: "/images/materials/Firefly_Burner.png",
  ...
  },
  {
    ...
    rarity: "EPIC",
    icon: "rocket_launch",
    imageUrl: "/images/loot/Rocketeer_Driver.png",
  ...
  },
  {
    ...
    rarity: "RARE",
    icon: "wb_sunny",
    imageUrl: "https://arcraiders.wiki/w/images/a/a2/Comet_Igniter.png",
  ...
  },
  {
    ...
    rarity: "UNCOMMON",
    icon: "shield",
    imageUrl: "https://arcraiders.wiki/w/images/d/df/Light_Shield.png",
  ...
  },
  {
    ...
    rarity: "RARE",
    icon: "shield",
    imageUrl: "https://arcraiders.wiki/w/images/1/14/Medium_Shield.png",
  ...
  },
  {
    ...
    rarity: "EPIC",
    icon: "shield",
    imageUrl: "https://arcraiders.wiki/w/images/b/b2/Heavy_Shield.png",
  ...
  },
  {
    ...
    rarity: "UNCOMMON",
    icon: "opacity",
    imageUrl: "https://arcraiders.wiki/w/images/d/d4/Oil.png",
  ...
  },
  {
    ...
    rarity: "RARE",
    icon: "linear_scale",
    imageUrl: "/images/materials/Rope.png",
  ...
  },
  {
    ...
    rarity: "RARE",
    icon: "sensors",
    imageUrl: "/images/materials/Sensors.png",
  ...
  },
  {
    ...
    rarity: "LEGENDARY",
    icon: "reactor",
    imageUrl: "https://arcraiders.wiki/w/images/c/cf/Queen_Reactor.png",
  ...
  },
  {
    ...
    rarity: "EPIC",
    icon: "settings",
    imageUrl: "https://arcraiders.wiki/w/images/9/96/Shredder_Gyro.png",
...
var MODS_DATA = [
  ...
  { id: "m1", name: "Compensator I", recycleInfo: [{
    ...
    purchasableFromCeleste: true,
    quantity: 2
  }], imageUrl: "/images/mods/Compensator_I.png" },
  { id: "m2", name: "Compensator II", recycleInfo: [{ name: "Mechanical Components", stackSize: 10, quantity: 1 }, {
    ...
    purchasableFromCeleste: true,
    quantity: 4
  }], imageUrl: "/images/mods/Compensator_II.png" },
  { id: "m3", name: "Compensator III", recycleInfo: [{ name: "Mod Components", stackSize: 5, quantity: 1 }, {
    ...
    purchasableFromCeleste: true,
    quantity: 6
  }], imageUrl: "/images/mods/Compensator_III.png" },
  { id: "mb1", name: "Muzzle Brake I", recycleInfo: [{
    ...
    purchasableFromCeleste: true,
    quantity: 3
  }], imageUrl: "/images/loot/Muzzle_Brake_III.png" },
  ...
  { id: "m5", name: "Shotgun Choke I", recycleInfo: [{
    ...
    purchasableFromCeleste: true,
    quantity: 2
  }], imageUrl: "/images/loot/Shotgun_Choke_III.png", weaponTypeCompatibility: ["SHOTGUN"] },
  ...
  { id: "ms1", name: "Silencer I", recycleInfo: [{ name: "Mechanical Components", stackSize: 10, quantity: 1 }, {
    ...
    purchasableFromCeleste: true,
    quantity: 2
  }], imageUrl: "/images/mods/Silencer_II.png" },
  ...
  { id: "m4", name: "Extended Barrel", recycleInfo: [{ name: "Mod Components", stackSize: 5, quantity: 1 }, {
    ...
    purchasableFromCeleste: true,
    quantity: 8
  }], imageUrl: "/images/mods/Extended_Barrel.png" },
  // MAGAZINE
  { id: "m10", name: "Extended Light Mag I", recycleInfo: [{
    ...
    purchasableFromCeleste: true,
    quantity: 2
  }], imageUrl: "/images/mods/Extended_Light_Mag_I.png", ammoCompatibility: "LIGHT" },
  { id: "m10b", name: "Extended Light Mag II", recycleInfo: [{ name: "Mechanical Components", stackSize: 10, quantity: 1 }, {
    ...
    purchasableFromCeleste: true,
    quantity: 4
  }], imageUrl: "/images/mods/Extended_Light_Mag_II.png", ammoCompatibility: "LIGHT" },
  { id: "m11", name: "Extended Light Mag III", recycleInfo: [{ name: "Mod Components", stackSize: 5, quantity: 1 }, {
    ...
    purchasableFromCeleste: true,
    quantity: 5
  }], imageUrl: "/images/mods/Extended_Light_Mag_III.png", ammoCompatibility: "LIGHT" },
  { id: "m12", name: "Extended Medium Mag I", recycleInfo: [{
    ...
    purchasableFromCeleste: true,
    quantity: 2
  }], imageUrl: "/images/loot/Extended_Medium_Mag_II.png", ammoCompatibility: "MEDIUM" },
  ...
  { id: "m14", name: "Extended Medium Mag III", recycleInfo: [{ name: "Mod Components", stackSize: 5, quantity: 1 }, {
    ...
    purchasableFromCeleste: true,
    quantity: 4
  }], imageUrl: "/images/mods/Extended_Medium_Mag_III.png", ammoCompatibility: "MEDIUM" },
  { id: "msm1", name: "Extended Shotgun Mag I", recycleInfo: [{
    ...
    purchasableFromCeleste: true,
    quantity: 1
  }], imageUrl: "/images/mods/Extended_Shotgun_Mag_III.png", ammoCompatibility: "SHOTGUN" },
  ...
  { id: "m18", name: "Angled Grip I", recycleInfo: [{
    ...
    purchasableFromCeleste: true,
    quantity: 2
  }], imageUrl: "/images/loot/Angled_Grip_III.png" },
  ...
  { id: "mv1", name: "Vertical Grip I", recycleInfo: [{
    ...
    purchasableFromCeleste: true,
    quantity: 2
  }], imageUrl: "/images/loot/Vertical_Grip_II.png" },
  ...
  { id: "m22", name: "Vertical Grip III", recycleInfo: [{ name: "Mechanical Components", stackSize: 10, quantity: 2 }, {
    ...
    purchasableFromCeleste: true,
    quantity: 6
  }], imageUrl: "/images/mods/Vertical_Grip_III.png" },
  { id: "m23", name: "Horizontal Grip", recycleInfo: [{ name: "Mod Components", stackSize: 5, quantity: 1 }, {
    name: "Duct Tape",
    purchasableFromCeleste: true,
    stackSize: 15,
    quantity: 2
  }], salvageInfo: [{ name: "Mechanical Components", stackSize: 10, quantity: 2 }], category: "UNDERBARREL", rarity: "EPIC", icon: "pan_tool_alt", tier: 3, description: "30% Reduced Horizontal Recoil, 30% Reduced Vertical Recoil, 30% Reduced ADS Speed", materials: [], imageUrl: "https://arcraiders.wiki/w/images/9/94/Mechanical_Components.png" },
  // STOCK
  { id: "m24", name: "Stable Stock I", recycleInfo: [{
    ...
    purchasableFromCeleste: true,
    quantity: 2
  }], imageUrl: "/images/loot/Stable_Stock_III.png" },
  ...
  { id: "mp3", name: "Padded Stock III", recycleInfo: [{ name: "Mod Components", quantity: 1 }], salvageInfo: [{ name: "Mechanical Components", quantity: 1 }], category: "STOCK", rarity: "RARE", icon: "format_underlined", tier: 3, description: "20% Reduced Base Dispersion, 20% Reduced Vertical/Horizontal Recoil, 50% Reduced ADS Speed", materials: [{ name: "Mod Components", quantity: 2 }, {
    ...
    purchasableFromCeleste: true,
    quantity: 6
  }], imageUrl: "/images/mods/Stable_Stock_III.png" },
  { id: "m27", name: "Lightweight Stock", recycleInfo: [{ name: "Mod Components", stackSize: 5, quantity: 1 }, {
    ...
    purchasableFromCeleste: true,
    quantity: 5
  }], imageUrl: "/images/mods/Lightweight_Stock.png" },
  { id: "m28", name: "Kinetic Converter", recycleInfo: [{ name: "Mod Components", stackSize: 5, quantity: 1 }, {
    name: "Duct Tape",
    purchasableFromCeleste: true,
    stackSize: 15,
    quantity: 2
  }], salvageInfo: [{ name: "Mechanical Components", stackSize: 10, quantity: 2 }], category: "STOCK", rarity: "LEGENDARY", icon: "bolt", tier: "LEGENDARY", description: "15% Increased Fire Rate, 20% Increased Horizontal Recoil, 20% Increased Vertical Recoil", materials: [], imageUrl: "https://arcraiders.wiki/w/images/9/94/Mechanical_Components.png" },
  { id: "m-anvilsplitter", name: "Anvil Splitter", recycleInfo: [{ name: "Mod Components", stackSize: 5, quantity: 1 }, {
    name: "Processor",
    purchasableFromCeleste: true,
    stackSize: 5,
    quantity: 1
  }], salvageInfo: [{ name: "Mechanical Components", stackSize: 10, quantity: 2 }], category: "ALL", rarity: "LEGENDARY", icon: "bolt", tier: "LEGENDARY", description: "+3 Projectiles Per Shot, 70% Reduced Projectile Damage", materials: [], imageUrl: "https://arcraiders.wiki/w/images/9/94/Mechanical_Components.png" },
  { id: "m-shotgunsilencer", name: "Shotgun Silencer", recycleInfo: [{ name: "Mod Components", stackSize: 5, quantity: 1 }, {
    ...
    purchasableFromCeleste: true,
    quantity: 8
  }], imageUrl: "/images/mods/Silencer_II.png", weaponTypeCompatibility: ["SHOTGUN"] }
];
var WEAPON_MOD_SLOTS = {
  "w3": ["Muzzle", "Light Magazine", "Underbarrel", "Stock"],
  // Kettle
  "w-rattler": ["Muzzle", "Underbarrel", "Stock"],
  // Rattler
  "w-arpeggio": ["Muzzle", "Medium Magazine", "Underbarrel", "Stock"],
  // Arpeggio
  "w-tempest": ["Muzzle", "Medium Magazine", "Underbarrel"],
  // Tempest
  "w-bettina": ["Muzzle", "Underbarrel", "Stock"],
  // Bettina
  "w1": ["Muzzle", "Underbarrel", "Stock"],
  // Ferro
  "w7": ["Muzzle", "Medium Magazine", "Stock"],
  // Renegade
  "w-aphelion": ["Underbarrel", "Stock"],
  // Aphelion
  "w2": ["Muzzle", "Light Magazine", "Underbarrel", "Stock"],
  // Stitcher
  "w-bobcat": ["Muzzle", "Light Magazine", "Underbarrel", "Stock"],
  // Bobcat
  "w4": ["Shotgun Muzzle", "Shotgun Magazine", "Underbarrel", "Stock"],
  // Il Toro
  "w-vulcano": ["Shotgun Muzzle", "Shotgun Magazine", "Underbarrel", "Stock"],
  // Vulcano
  "w-hairpin": ["Light Magazine"],
  // Hairpin
  "w6": ["Muzzle", "Light Magazine"],
  // Burletta
  "w8": ["Medium Magazine", "Underbarrel"],
  // Venator
  "w5": ["Muzzle", "Tech Mod"],
  // Anvil
  "w10": ["Muzzle", "Medium Magazine", "Stock"],
  // Torrente
  "w9": ["Muzzle", "Medium Magazine", "Underbarrel", "Stock"],
  // Osprey
  "w-hullcracker": ["Underbarrel", "Stock"],
  // Hullcracker
  "w-jupiter": [],
  // Jupiter (no mod slots)
  "w-equalizer": []
  // Equalizer (no mod slots)
};
var WEAPONS_DATA = [
  {
    id: "w-rattler",
    ...
    rarity: "COMMON",
    icon: "my_location",
    imageUrl: "/images/weapons/Rattler.webp",
    craftInfo: { materials: [{
      name: "Metal Parts",
      purchasableFromCeleste: true,
      quantity: 16
  ...
  },
  {
    ...
    rarity: "UNCOMMON",
    icon: "my_location",
    imageUrl: "/images/weapons/Arpeggio.webp",
    craftInfo: { materials: [{ name: "Mechanical Components", quantity: 6 }, {
      name: "Simple Gun Parts",
      purchasableFromCeleste: true,
      quantity: 6
    }], station: "Gunsmith 2" },
  ...
  },
  {
    ...
    rarity: "EPIC",
    icon: "my_location",
    imageUrl: "/images/weapons/Tempest.webp",
    craftInfo: { materials: [{ name: "Magnetic Accelerator", quantity: 1 }, {
      name: "Medium Gun Parts",
      purchasableFromCeleste: true,
      quantity: 3
    }, {
  ...
  },
  {
    ...
    rarity: "EPIC",
    icon: "my_location",
    imageUrl: "/images/weapons/Bettina.png",
    craftInfo: { materials: [{ name: "Adv Mechanical Components", quantity: 3 }, {
      name: "Heavy Gun Parts",
      purchasableFromCeleste: true,
      quantity: 3
    }, {
  ...
  },
  {
    ...
    craftInfo: { materials: [{ name: "Magnetic Accelerator", quantity: 3 }, {
      name: "Complex Gun Parts",
      purchasableFromCeleste: true,
      quantity: 3
    ...
    upgradeInfo: [],
    recycleInfo: [{ tier: "I", materials: [{ name: "Magnetic Accelerator", quantity: 2 }, {
      name: "Complex Gun Parts",
      purchasableFromCeleste: true,
      quantity: 1
    }] }],
  ...
  },
  {
    ...
    rarity: "EPIC",
    icon: "my_location",
    imageUrl: "/images/weapons/Bobcat.webp",
    craftInfo: { materials: [{ name: "Magnetic Accelerator", quantity: 1 }, {
      name: "Light Gun Parts",
      purchasableFromCeleste: true,
      quantity: 3
  ...
  },
  {
    ...
    rarity: "EPIC",
    icon: "my_location",
    imageUrl: "/images/weapons/Vulcano.webp",
    craftInfo: { materials: [{ name: "Magnetic Accelerator", quantity: 1 }, {
      name: "Heavy Gun Parts",
      purchasableFromCeleste: true,
      quantity: 3
  ...
  },
  {
    ...
    rarity: "COMMON",
    icon: "my_location",
    imageUrl: "/images/weapons/Hairpin.webp",
    craftInfo: { materials: [{
      name: "Metal Parts",
      purchasableFromCeleste: true,
      quantity: 2
  ...
  },
  {
    ...
    rarity: "EPIC",
    icon: "my_location",
    imageUrl: "/images/weapons/Hullcracker.webp",
    craftInfo: { materials: [{ name: "Magnetic Accelerator", quantity: 1 }, {
      name: "Heavy Gun Parts",
      purchasableFromCeleste: true,
      quantity: 3
  ...
  },
  {
    ...
    rarity: "COMMON",
    icon: "handyman",
    imageUrl: "/images/weapons/Ferro.png",
    craftInfo: { materials: [{
      name: "Metal Parts",
      purchasableFromCeleste: true,
      quantity: 15
  ...
  },
  {
    ...
    rarity: "COMMON",
    icon: "adjust",
    imageUrl: "/images/weapons/Stitcher.png",
    craftInfo: { materials: [{
      name: "Metal Parts",
      purchasableFromCeleste: true,
      quantity: 8
  ...
  },
  {
    ...
    rarity: "COMMON",
    icon: "fireplace",
    imageUrl: "/images/weapons/Kettle.png",
    craftInfo: { materials: [{
      name: "Metal Parts",
      purchasableFromCeleste: true,
      quantity: 6
  ...
  },
  {
    ...
    imageUrl: "/images/weapons/Il_Toro.png",
    craftInfo: { materials: [{ name: "Mechanical Components", quantity: 5 }, {
      name: "Simple Gun Parts",
      purchasableFromCeleste: true,
      quantity: 6
    }], station: "Gunsmith 1" },
  ...
  },
  {
    ...
    rarity: "UNCOMMON",
    icon: "construction",
    imageUrl: "/images/weapons/Anvil.png",
    craftInfo: { materials: [{ name: "Mechanical Components", quantity: 5 }, {
      name: "Simple Gun Parts",
      purchasableFromCeleste: true,
      quantity: 6
  ...
  },
  {
    ...
    rarity: "UNCOMMON",
    icon: "speed",
    imageUrl: "/images/weapons/Burletta.png",
    craftInfo: { materials: [{ name: "Mechanical Components", quantity: 3 }, {
      name: "Simple Gun Parts",
      purchasableFromCeleste: true,
      quantity: 3
    }], station: "Gunsmith 1" },
  ...
  },
  {
    ...
    rarity: "RARE",
    icon: "dangerous",
    imageUrl: "/images/weapons/Renegade.png",
    craftInfo: { materials: [{ name: "Adv Mechanical Components", quantity: 2 }, {
      name: "Medium Gun Parts",
      purchasableFromCeleste: true,
      quantity: 3
    }, {
  ...
  },
  {
    ...
    rarity: "RARE",
    icon: "track_changes",
    imageUrl: "/images/weapons/Venator.png",
    craftInfo: { materials: [{ name: "Adv Mechanical Components", quantity: 2 }, {
      name: "Medium Gun Parts",
      purchasableFromCeleste: true,
      quantity: 3
  ...
  },
  {
    ...
    rarity: "RARE",
    icon: "gps_fixed",
    imageUrl: "/images/weapons/Osprey.png",
    craftInfo: { materials: [{ name: "Adv Mechanical Components", quantity: 2 }, {
      name: "Medium Gun Parts",
      purchasableFromCeleste: true,
      quantity: 3
  ...
  },
  {
    ...
    rarity: "RARE",
    icon: "local_fire_department",
    imageUrl: "/images/weapons/Torrente.png",
    craftInfo: { materials: [{ name: "Adv Mechanical Components", quantity: 2 }, {
      name: "Medium Gun Parts",
      purchasableFromCeleste: true,
      quantity: 3
  ...
  // ─── NEW: Canto (RARE SMG, Medium Ammo) ───────────────────────────────
  {
    ...
    rarity: "RARE",
    icon: "mode_fan",
    imageUrl: "https://arcraiders.wiki/w/images/8/83/Canto-Level1.png",
    ammoType: "MEDIUM",
    weaponType: "SMG",
  ...
  // ─── NEW: Dolabra (LEGENDARY Shotgun, Energy Clip) ────────────────────
  {
    ...
    rarity: "LEGENDARY",
    icon: "bolt",
    imageUrl: "https://arcraiders.wiki/w/images/0/07/Dolabra-Level1.png",
    ammoType: "ENERGY",
    weaponType: "SHOTGUN",
...
var THROWABLES_DATA = [
  ...
  { "id": "t-tagging", "name": "Tagging Grenade", "imageUrl": "https://arcraiders.wiki/w/images/e/e5/Tagging_Grenade.png", "rarity": "RARE", "icon": "my_location", "category": "THROWABLES", "description": "A tactical grenade that tags enemies through walls.", "craftInfo": { "station": "Explosives Station II", "quantityProduced": 1, "materials": [{ "name": "Electrical Components", "quantity": 1 }, { "name": "Sensors", "quantity": 1 }] } },
  // THROWABLES
  {
    id: "t1",
    ...
    description: "",
    category: "THROWABLES",
    craftInfo: { station: "Topside (In-Round)", quantityProduced: 1, materials: [{
      name: "Plastic Parts",
      purchasableFromCeleste: true,
      quantity: 2
    }, {
  ...
  },
  {
    ...
    description: "",
    category: "THROWABLES",
    craftInfo: { station: "Refiner 2", quantityProduced: 1, materials: [{
      name: "Chemicals",
      purchasableFromCeleste: true,
      quantity: 14
    }, {
  ...
  },
  {
    ...
    description: "",
    category: "THROWABLES",
    craftInfo: { station: "Explosives Station III", quantityProduced: 1, materials: [{ name: "Electrical Components", quantity: 1 }, { name: "Hornet Driver", quantity: 1 }, {
      name: "Voltage Converter",
      purchasableFromCeleste: true,
      quantity: 1
    }] }
  },
  {
    ...
    imageUrl: "https://arcraiders.wiki/w/images/5/5a/Jolt_Mine.png",
    stackSize: 3,
    description: "",
    category: "THROWABLES",
    craftInfo: { station: "Explosives Station II", quantityProduced: 1, materials: [{ name: "Electrical Components", quantity: 1 }, {
      name: "Battery",
      purchasableFromCeleste: true,
      quantity: 1
    }] }
  },
  {
    ...
    rarity: "RARE",
    icon: "trip_origin",
    imageUrl: "https://arcraiders.wiki/w/images/2/22/Explosive_Mine.png",
    stackSize: 3,
    description: "",
    category: "THROWABLES",
    craftInfo: { station: "Explosives Station III", quantityProduced: 1, materials: [{ name: "Explosive Compound", quantity: 1 }, {
      name: "Sensors",
      purchasableFromCeleste: true,
      quantity: 1
    }] }
  },
  {
    ...
    rarity: "COMMON",
    icon: "explosion",
    imageUrl: "/images/loot/Snap_Blast_Grenade.png",
    stackSize: 3,
    description: "",
    category: "THROWABLES",
    craftInfo: { station: "Explosives Station II", quantityProduced: 1, materials: [{ name: "Crude Explosives", quantity: 2 }, {
      name: "Magnet",
      purchasableFromCeleste: true,
      quantity: 1
    }] }
  },
  {
    ...
    rarity: "RARE",
    icon: "back_hand",
    imageUrl: "https://arcraiders.wiki/w/images/c/cc/Trigger_%27Nade.png",
    stackSize: 5,
    recycleInfo: [{
      name: "Chemicals",
      purchasableFromCeleste: true,
    ...
    description: "A remote-detonated Grenade that explodes after being triggered. It can stick to almost any surface when thrown.",
    category: "THROWABLES",
    craftInfo: { station: "Explosives Station II", quantityProduced: 1, materials: [{ name: "Crude Explosives", quantity: 2 }, {
      name: "Processor",
      purchasableFromCeleste: true,
  ...
  },
  {
    ...
    description: "",
    category: "THROWABLES",
    craftInfo: { station: "Explosives Station III", quantityProduced: 1, materials: [{
      name: "Synthesized Fuel",
      purchasableFromCeleste: true,
      quantity: 1
  ...
  },
  {
    id: "t12",
    name: "Wolfpack",
    recycleInfo: [{ name: "ARC Motion Core", stackSize: 5, quantity: 1 }, { name: "Explosive Compound", stackSize: 5, quantity: 1 }],
    salvageInfo: [{ name: "Explosive Compound", stackSize: 5, quantity: 2 }],
    rarity: "EPIC",
    icon: "rocket_launch",
    imageUrl: "https://arcraiders.wiki/w/images/2/24/Wolfpack.png",
    stackSize: 1,
    description: "",
    category: "THROWABLES",
  ...
  },
  {
    id: "t13",
    name: "Seeker Grenade",
    recycleInfo: [{ name: "Crude Explosives", stackSize: 10, quantity: 1 }],
    salvageInfo: [{
      name: "Chemicals",
      purchasableFromCeleste: true,
      stackSize: 50,
  ...
  },
  {
    ...
    description: "",
    category: "THROWABLES",
    craftInfo: { station: "Explosives Station I", quantityProduced: 1, materials: [{ name: "Crude Explosives", quantity: 1 }, {
      name: "Steel Spring",
      purchasableFromCeleste: true,
      quantity: 2
    }] }
  },
  {
    id: "t15",
    name: "Deadline",
    recycleInfo: [{ name: "Explosive Compound", stackSize: 5, quantity: 1 }, { name: "ARC Circuitry", stackSize: 5, quantity: 1 }],
    salvageInfo: [{ name: "Explosive Compound", stackSize: 5, quantity: 1 }],
    rarity: "EPIC",
    icon: "warning",
    imageUrl: "https://arcraiders.wiki/w/images/c/c7/Deadline.png",
    stackSize: 1,
    description: "",
    category: "THROWABLES",
  ...
  // DEFENSIVE - SHIELDS
  {
    ...
    craftInfo: { station: "Gear Bench 1", quantityProduced: 1, materials: [{ name: "ARC Alloy", quantity: 2 }, {
      name: "Plastic Parts",
      purchasableFromCeleste: true,
      quantity: 4
    }] },
  ...
  },
  {
    ...
    craftInfo: { station: "Gear Bench 2", quantityProduced: 1, materials: [{
      name: "Battery",
      purchasableFromCeleste: true,
      quantity: 4
  ...
  },
  {
    ...
    craftInfo: { station: "Gear Bench 3", quantityProduced: 1, materials: [{ name: "Power Rod", quantity: 1 }, {
      name: "Voltage Converter",
      purchasableFromCeleste: true,
      quantity: 2
    }] },
  ...
  // DEFENSIVE - QUICK USE
  {
    ...
    category: "DEFENSIVE",
    stackSize: 5,
    imageUrl: "https://arcraiders.wiki/w/images/6/68/Shield_Recharger.png",
    description: "Quick Use item that can be used to recharge Shields over time.",
    craftInfo: { station: "Refiner 1", quantityProduced: 1, materials: [{
      name: "Rubber Parts",
      purchasableFromCeleste: true,
      quantity: 4
  ...
  },
  {
    ...
    category: "DEFENSIVE",
    stackSize: 5,
    imageUrl: "https://arcraiders.wiki/w/images/a/a6/Surge_Shield_Recharger.png",
  ...
  },
  {
    id: "t21",
    name: "Vita Spray",
    recycleInfo: [{ name: "Antiseptic", stackSize: 5, quantity: 1 }, {
      name: "Canister",
      purchasableFromCeleste: true,
      stackSize: 15,
      quantity: 1
    }],
    salvageInfo: [{ name: "Antiseptic", stackSize: 5, quantity: 1 }],
    rarity: "EPIC",
    icon: "medication",
    category: "DEFENSIVE",
    stackSize: 1,
    imageUrl: "https://arcraiders.wiki/w/images/9/9f/Vita_Spray.png",
    description: "A pressurized healing spray that restores health rapidly over time.",
    craftInfo: { station: "Refiner 2", quantityProduced: 1, materials: [{ name: "Antiseptic", quantity: 4 }, {
      name: "Canister",
      purchasableFromCeleste: true,
      quantity: 1
  ...
  },
  {
    ...
    category: "DEFENSIVE",
    stackSize: 3,
    imageUrl: "/images/materials/7d/Vita_Shot.png",
    description: "An injectable healing agent that provides an immediate boost to health.",
    craftInfo: { station: "Refiner 2", quantityProduced: 1, materials: [{ name: "Antiseptic", quantity: 3 }, {
      name: "Syringe",
      purchasableFromCeleste: true,
      quantity: 1
    }] }
  },
  {
    ...
    recycleInfo: [{
      ...
      stackSize: 50,
      quantity: 1
    }, { name: "Antiseptic", stackSize: 5, quantity: 1 }],
    salvageInfo: [{ name: "Durable Cloth", stackSize: 10, quantity: 1 }],
    rarity: "RARE",
    icon: "healing",
    category: "DEFENSIVE",
    stackSize: 3,
    imageUrl: "/images/materials/99/Sterilized_Bandage.png",
  ...
  },
  {
    ...
    category: "DEFENSIVE",
    stackSize: 5,
    imageUrl: "/images/materials/c5/Herbal_Bandage.png",
  ...
  },
  {
    ...
    category: "DEFENSIVE",
    stackSize: 3,
    imageUrl: "/images/materials/5f/Defibrillator.png",
  ...
  // ─── NEW GRENADES ──────────────────────────────────────────────────────
  {
    ...
    category: "THROWABLES",
    description: "Detonates to create a lingering toxic gas cloud that drains stamina.",
    stackSize: 5,
  ...
  },
  {
    ...
    rarity: "COMMON",
    icon: "radar",
    imageUrl: "https://arcraiders.wiki/w/images/7/77/Lure_Grenade.png",
    category: "THROWABLES",
    description: "Emits a signal that attracts nearby ARC to its location.",
    stackSize: 5,
  ...
  },
  {
    ...
    imageUrl: "/images/loot/Electrical_Components.png",
    category: "THROWABLES",
    description: "A smaller smoke grenade that creates a brief, compact smoke screen.",
    stackSize: 5,
  ...
  // ─── NEW TRAPS ─────────────────────────────────────────────────────────
  {
    ...
    imageUrl: "https://arcraiders.wiki/w/images/2/24/Blaze_Grenade.png",
    category: "THROWABLES",
    description: "A laser tripwire trap that detonates a Blaze Grenade when triggered.",
    stackSize: 3,
  ...
  },
  {
    ...
    imageUrl: "/images/materials/Wires.png",
    category: "THROWABLES",
    description: "A laser tripwire trap that releases toxic gas when triggered.",
    stackSize: 3,
  ...
  },
  {
    ...
    imageUrl: "/images/materials/Wires.png",
    category: "THROWABLES",
    description: "A proximity mine that releases a cloud of toxic gas when triggered.",
    stackSize: 3,
  ...
  },
  {
    ...
    rarity: "UNCOMMON",
    icon: "flash_on",
    imageUrl: "https://arcraiders.wiki/w/images/a/af/Pulse_Mine.png",
    category: "THROWABLES",
    description: "A proximity mine that releases an EMP pulse, disabling nearby ARC on trigger.",
    stackSize: 3,
  ...
  },
  {
    ...
    imageUrl: "https://arcraiders.wiki/w/images/7/77/Lure_Grenade.png",
    category: "THROWABLES",
    description: "A laser tripwire trap that triggers a lure signal to distract ARC.",
    stackSize: 3,
  ...
  },
  {
    ...
    imageUrl: "https://arcraiders.wiki/w/images/d/d5/Smoke_Grenade.png",
    category: "THROWABLES",
    description: "A laser tripwire trap that deploys a smoke screen when triggered.",
    stackSize: 3,
  ...
  // ─── NEW QUICK USE / HEALING ────────────────────────────────────────────
  {
    ...
    imageUrl: "/images/materials/Wires.png",
    category: "QUICK USE",
    description: "A basic wound dressing. Stops bleeding and restores a small amount of health over time.",
    stackSize: 5,
  ...
  },
  {
    ...
    imageUrl: "/images/materials/3b/Adrenaline_Shot.png",
    category: "QUICK USE",
    description: "A powerful stimulant that rapidly restores stamina and briefly boosts movement speed.",
    stackSize: 3,
  ...
  // ─── NEW GADGETS / UTILITY ─────────────────────────────────────────────
  {
    ...
    imageUrl: "/images/materials/Metal_Parts.png",
    category: "QUICK USE",
    description: "Deploys a reinforced barricade panel to block doorways and chokepoints.",
    stackSize: 2,
  ...
  },
  {
    ...
    rarity: "RARE",
    icon: "route",
    imageUrl: "https://arcraiders.wiki/w/images/f/f9/Zipline.png",
    category: "QUICK USE",
    description: "Creates a bidirectional zipline between two anchor points for rapid traversal.",
    stackSize: 2,
...
var AUGMENTS_DATA = [
  {
    ...
    quickUseSlots: 4,
    safePocketSlots: 1,
    shieldCompat: "Light / Medium / Heavy",
    craftInfo: { station: "Refiner 3", quantityProduced: 1, materials: [{ name: "Adv Electrical Components", quantity: 2 }, {
      name: "Processor",
      purchasableFromCeleste: true,
      quantity: 3
    }] },
  ...
  },
  {
    ...
    perks: "+3 slots de Utility e pistolas/hand cannons equipam ~33% mais r\xE1pido.",
    maxWeight: "60",
    backpackSlots: 20,
    quickUseSlots: 5,
    safePocketSlots: 2,
  ...
  },
  {
    ...
    perks: "+3 slots de Trinket e joga fora Ticks presos em voc\xEA ap\xF3s ~1 s.",
    maxWeight: "60",
    backpackSlots: 22,
    quickUseSlots: 4,
    safePocketSlots: 2,
  ...
  },
  {
    ...
    perks: "Adrenaline Shot autom\xE1tico ao quebrar o escudo, com cooldown.",
    maxWeight: "70",
    backpackSlots: 24,
    quickUseSlots: 5,
    safePocketSlots: 2,
  ...
  },
  {
    ...
    perks: "Alt\xEDssimo peso + mochila, +1 Utility; 'mula' m\xE1xima, sem perk ativ\xE1vel.",
    maxWeight: "80",
    backpackSlots: 20,
    quickUseSlots: 5,
    safePocketSlots: 3,
    shieldCompat: "Light / Medium",
    craftInfo: { station: "Refiner 3", quantityProduced: 1, materials: [{ name: "Adv Electrical Components", quantity: 2 }, {
      name: "Processor",
      purchasableFromCeleste: true,
      quantity: 3
  ...
  },
  {
    ...
    perks: "+1 slot de Utility e fuma\xE7a autom\xE1tica ao quebrar o escudo (CD fixo).",
    maxWeight: "45",
    backpackSlots: 17,
    quickUseSlots: 5,
    safePocketSlots: 1,
  ...
  },
  {
    ...
    perks: "Integrated Defibrillator (revive gr\xE1tis com cooldown) e regen leve de HP.",
    maxWeight: "65",
    backpackSlots: 16,
    quickUseSlots: 5,
    safePocketSlots: 2,
  ...
  },
  {
    ...
    icon: "shield_with_heart",
    category: "AUGMENT",
    imageUrl: "/images/materials/14/Combat_Mk.png",
  ...
  },
  {
    ...
    perks: "+1 slot de granada e regen de 1 HP a cada 5 s (pausa 30 s ap\xF3s dano).",
    maxWeight: "55",
    backpackSlots: 18,
    quickUseSlots: 4,
    safePocketSlots: 1,
  ...
  },
  {
    ...
    icon: "tactic",
    category: "AUGMENT",
    imageUrl: "/images/materials/18/Tactical_Mk.png",
...
var LOOT_DATA = [
  // --- NON-CRAFTABLE ITEMS FIRST (A-Z) ---
  {
    id: "loot-arc-alloy",
    material: "ARC Alloy",
    materialImageUrl: "/images/loot/ARC_Alloy.png",
    wikiUrl: "https://arcraiders.wiki/wiki/ARC_Alloy",
    sources: [
      { name: "Damaged Leaper Pulse Unit", quantity: 3, imageUrl: "/images/materials/Wires.png" },
      ...
      { name: "Heavy Shield", quantity: 3, imageUrl: "https://arcraiders.wiki/w/images/f/f9/Heavy_Shield.png" },
      { name: "ARC Circuitry", quantity: 2, imageUrl: "/images/loot/ARC_Circuitry.png" },
      { name: "ARC Motion Core", quantity: 2, imageUrl: "/images/loot/ARC_Motion_Core.png" },
  ...
  },
  {
    ...
    materialImageUrl: "/images/loot/ARC_Powercell.png",
  ...
  },
  {
    ...
    material: "Duct Tape",
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Duct_Tape.png",
    ...
    sources: [
      ...
      { name: "Stable Stock III", quantity: 2, imageUrl: "/images/loot/Stable_Stock_III.png" },
  ...
  },
  {
    ...
    material: "Chemicals",
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Chemicals.png",
    wikiUrl: "https://arcraiders.wiki/wiki/Chemicals",
    sources: [
      { name: "Vita Shot", quantity: 4, imageUrl: "https://arcraiders.wiki/w/images/7/7d/Vita_Shot.png" },
      ...
      { name: "Bleach", quantity: 1, imageUrl: "/images/loot/Bleach.png" },
      {
        ...
        purchasableFromCeleste: true,
        quantity: 1,
        imageUrl: "/images/loot/Syringe.png"
      }
    ]
  },
  {
    ...
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Rubber_Parts.png",
    ...
    sources: [
      ...
      { name: "Mechanical Components", quantity: 2, imageUrl: "https://arcraiders.wiki/w/images/9/94/Mechanical_Components.png" },
  ...
  },
  {
    ...
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Plastic_Parts.png",
    ...
    sources: [
      ...
      { name: "Vita Shot", quantity: 1, imageUrl: "https://arcraiders.wiki/w/images/7/7d/Vita_Shot.png" },
      { name: "Electrical Components", quantity: 3 },
      { name: "ARC Synthetic Resin", quantity: 14, imageUrl: "/images/loot/Electrical_Components.png" },
      ...
      { name: "Angled Grip I", quantity: 6, imageUrl: "/images/loot/Angled_Grip_III.png" }
    ]
  },
  {
    id: "loot-magnet",
    material: "Magnet",
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Magnet.png",
  ...
  },
  {
    ...
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Metal_Parts.png",
    ...
    sources: [
      ...
      { name: "Mechanical Components", quantity: 3, imageUrl: "https://arcraiders.wiki/w/images/9/94/Mechanical_Components.png" },
      ...
      { name: "Unusable Weapon", quantity: 2, imageUrl: "https://arcraiders.wiki/w/images/3/37/Unusable_Weapon.png" }
    ]
  },
  {
    id: "loot-mod-components",
    material: "Mod Components",
    materialImageUrl: "/images/materials/Mod_Components.png",
    wikiUrl: "https://arcraiders.wiki/wiki/Mod_Components",
    craftingStation: "Refiner 2",
    sources: [
      { name: "Anvil Splitter", quantity: 1, imageUrl: "/images/loot/Anvil_Splitter.png" },
  ...
  },
  {
    ...
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Steel_Spring.png",
    wikiUrl: "https://arcraiders.wiki/wiki/Steel_Spring",
    sources: [
      { name: "Ruined Accordion", quantity: 3, imageUrl: "/images/mods/Extended_Barrel.png" },
  ...
  },
  {
    ...
    material: "Wires",
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Wires.png",
  ...
  // --- CRAFTABLE ITEMS LAST (A-Z) ---
  {
    ...
    materialImageUrl: "/images/materials/Advanced_electrical_components.png",
    ...
    sources: [
      ...
      { name: "Power Rod", quantity: 1, imageUrl: "https://arcraiders.wiki/w/images/3/31/Power_Rod.png" },
  ...
  },
  {
    ...
    materialImageUrl: "/images/materials/Advanced_Mechanical_Components.png",
  ...
  },
  {
    ...
    materialImageUrl: "/images/loot/Electrical_Components.png",
    ...
    sources: [
      ...
      { name: "Adv Electrical Components", quantity: 1, imageUrl: "/images/materials/Advanced_electrical_components.png" },
      { name: "Combat Mk. 2", quantity: 1, imageUrl: "/images/loot/Combat_Mk._2.png" },
      { name: "Looting Mk. 2", quantity: 1, imageUrl: "/images/loot/Looting_Mk._2.png" }
    ]
  },
  {
    ...
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Heavy_Gun_Parts.png",
  ...
  },
  {
    ...
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Light_Gun_Parts.png",
  ...
  },
  {
    ...
    materialImageUrl: "/images/materials/Mechanical_Components.png",
  ...
  },
  {
    ...
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Medium_Gun_Parts.png",
  ...
  },
  {
    ...
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Simple_Gun_Parts.png",
    ...
    sources: [
      ...
      { name: "Unusable Weapon", quantity: 5, imageUrl: "https://arcraiders.wiki/w/images/3/37/Unusable_Weapon.png" },
  ...
  },
  {
    ...
    sources: [
      ...
      { name: "Deadline", quantity: 1, imageUrl: "https://arcraiders.wiki/w/images/c/c7/Deadline.png" },
  ...
  },
  {
    ...
    materialImageUrl: "/images/loot/ARC_Motion_Core.png",
    wikiUrl: "https://arcraiders.wiki/wiki/ARC_Motion_Core",
    sources: [
      { name: "Wolfpack", quantity: 1, imageUrl: "https://arcraiders.wiki/w/images/2/24/Wolfpack.png" },
  ...
  },
  {
    ...
    material: "Processor",
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Processor.png",
  ...
  },
  {
    ...
    materialImageUrl: "/images/materials/5e/Magnetic_Accelerator.png",
  ...
  // --- NEWLY ADDED MATERIALS ---
  {
    ...
    materialImageUrl: "/images/materials/Advanced_ARC_Powercell.png",
  ...
  },
  {
    id: "loot-antiseptic",
    material: "Antiseptic",
    materialImageUrl: "/images/materials/Antiseptic.png",
    wikiUrl: "https://arcraiders.wiki/wiki/Antiseptic",
    sources: [
      { name: "Vita Spray", quantity: 4, imageUrl: "/images/materials/1d/Vita_Spray.png" },
      { name: "Vita Shot", quantity: 3, imageUrl: "https://arcraiders.wiki/w/images/7/7d/Vita_Shot.png" },
      { name: "Sterilized Bandage", quantity: 1, imageUrl: "https://arcraiders.wiki/w/images/9/99/Sterilized_Bandage.png" },
  ...
  },
  {
    ...
    material: "Canister",
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Canister.png",
    wikiUrl: "https://arcraiders.wiki/wiki/Canister",
    sources: [
      { name: "Fire Extinguisher", quantity: 3 },
      { name: "Compressed Air Can", quantity: 2 },
      { name: "Vita Spray", quantity: 1, imageUrl: "/images/materials/1d/Vita_Spray.png" },
      { name: "Smoke Grenade", quantity: 1, imageUrl: "https://arcraiders.wiki/w/images/d/d5/Smoke_Grenade.png" },
      { name: "Heavy Fuze Grenade", quantity: 1, imageUrl: "https://arcraiders.wiki/w/images/e/ea/Heavy_Fuze_Grenade.png" }
    ]
  },
  {
    id: "loot-tick-pod",
    material: "Tick Pod",
    materialImageUrl: "/images/materials/Tick_Pod.png",
  ...
  },
  {
    ...
    material: "Fabric",
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Fabric.png",
    wikiUrl: "https://arcraiders.wiki/wiki/Fabric",
    sources: [
      { name: "Herbal Bandage", quantity: 5, imageUrl: "https://arcraiders.wiki/w/images/c/c5/Herbal_Bandage.png" },
  ...
  },
  {
    ...
    materialImageUrl: "/images/materials/Durable_Cloth.png",
    wikiUrl: "https://arcraiders.wiki/wiki/Durable_Cloth",
    craftingStation: "Refiner 1",
    sources: [
      { name: "Sterilized Bandage", quantity: 2, imageUrl: "https://arcraiders.wiki/w/images/9/99/Sterilized_Bandage.png" },
  ...
  },
  {
    ...
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Great_Mullein.png",
    wikiUrl: "https://arcraiders.wiki/wiki/Great_Mullein",
    sources: [
      { name: "Herbal Bandage", quantity: 2, imageUrl: "https://arcraiders.wiki/w/images/c/c5/Herbal_Bandage.png" },
  ...
  },
  {
    ...
    material: "Moss",
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Moss.png",
    wikiUrl: "https://arcraiders.wiki/wiki/Moss",
    sources: [
      { name: "Defibrillator", quantity: 1, imageUrl: "https://arcraiders.wiki/w/images/5/5f/Defibrillator.png" },
  ...
  },
  {
    ...
    material: "Battery",
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Battery.png",
    wikiUrl: "https://arcraiders.wiki/wiki/Battery",
    sources: [
      { name: "Jolt Mine", quantity: 1, imageUrl: "/images/materials/Jolt_mine.png" },
      { name: "Power Bank", quantity: 2, imageUrl: "/images/loot/Power_Bank.png" },
  ...
  },
  {
    id: "loot-power-rod",
    material: "Power Rod",
    materialImageUrl: "/images/loot/Power_Rod.png",
    wikiUrl: "https://arcraiders.wiki/wiki/Power_Rod",
    sources: [
      { name: "Queen Reactor", quantity: 1, imageUrl: "https://arcraiders.wiki/w/images/6/6b/Queen_Reactor.png" },
      { name: "Matriarch Reactor", quantity: 1, imageUrl: "https://arcraiders.wiki/w/images/2/24/Matriarch_Reactor.png" },
      { name: "Adv Electrical Components", quantity: 1, imageUrl: "/images/materials/Advanced_electrical_components.png" }
    ]
  },
  {
    ...
    material: "Syringe",
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Syringe.png",
  ...
  },
  {
    ...
    purchasableFromCeleste: true,
    materialImageUrl: "/images/loot/Exodus_Modules.png",
    ...
    sources: [
      ...
      { name: "Rocketeer Driver", quantity: 1, imageUrl: "/images/loot/Rocketeer_Driver.png" }
    ]
  },
  {
    id: "loot-crude-explosives",
    material: "Crude Explosives",
    materialImageUrl: "/images/materials/Crude_Explosives.png",
    wikiUrl: "https://arcraiders.wiki/wiki/Crude_Explosives",
    sources: [
      { name: "Trigger 'Nade", quantity: 2, imageUrl: "/images/materials/Trigger_nade.png" },
      { name: "Snap Blast Grenade", quantity: 1, imageUrl: "/images/loot/Snap_Blast_Grenade.png" },
      { name: "Trailblazer", quantity: 1, imageUrl: "/images/materials/Trailblazer.png" },
      { name: "Shrapnel Grenade", quantity: 1, imageUrl: "https://arcraiders.wiki/w/images/5/5f/Shrapnel_Grenade.png" },
      { name: "Seeker Grenade", quantity: 1, imageUrl: "https://arcraiders.wiki/w/images/3/35/Seeker_Grenade.png" }
    ]
  },
  {
    id: "loot-explosive-compound",
    material: "Explosive Compound",
    materialImageUrl: "/images/materials/Explosive_Compound.png",
    wikiUrl: "https://arcraiders.wiki/wiki/Explosive_Compound",
    sources: [
      { name: "Heavy Fuze Grenade", quantity: 2, imageUrl: "https://arcraiders.wiki/w/images/e/ea/Heavy_Fuze_Grenade.png" },
      { name: "Blaze Grenade", quantity: 1, imageUrl: "https://arcraiders.wiki/w/images/2/24/Blaze_Grenade.png" },
      { name: "Explosive Mine", quantity: 1, imageUrl: "https://arcraiders.wiki/w/images/2/22/Explosive_Mine.png" },
  ...
  },
  {
    ...
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Synthesized_Fuel.png",
    wikiUrl: "https://arcraiders.wiki/wiki/Synthesized_Fuel",
    sources: [
      { name: "Trailblazer", quantity: 2, imageUrl: "/images/materials/Trailblazer.png" },
  ...
  },
  {
    ...
    materialImageUrl: "/images/materials/Firefly_Burner.png",
  ...
  },
  {
    ...
    materialImageUrl: "/images/loot/Rocketeer_Driver.png",
  ...
  },
  {
    ...
    materialImageUrl: "/images/materials/Comet_Igniter.png",
  ...
  },
  {
    ...
    materialImageUrl: "/images/materials/Light_Shield.png",
  ...
  },
  {
    ...
    materialImageUrl: "/images/materials/Medium_Shield.png",
  ...
  },
  {
    ...
    materialImageUrl: "/images/materials/Heavy_Shield.png",
  ...
  },
  {
    ...
    material: "Oil",
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Oil.png",
    ...
    sources: [
      ...
      { name: "Blaze Grenade", quantity: 1, imageUrl: "https://arcraiders.wiki/w/images/2/24/Blaze_Grenade.png" },
      { name: "Explosive Mine", quantity: 2, imageUrl: "https://arcraiders.wiki/w/images/2/22/Explosive_Mine.png" },
  ...
  },
  {
    ...
    material: "Rope",
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Rope.png",
  ...
  },
  {
    ...
    material: "Sensors",
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Sensors.png",
  ...
  },
  {
    ...
    purchasableFromCeleste: true,
    materialImageUrl: "/images/materials/Speaker_component.png",
  ...
  },
  {
    ...
    materialImageUrl: "/images/loot/Hornet_Driver.png",
  ...
  },
  {
    ...
    materialImageUrl: "/images/materials/Matriarch_reactor.png",
  ...
  },
  {
    ...
    materialImageUrl: "/images/materials/Queen_reactor.png",
...
var WEAPON_SETUPS_DATA = [
  {
    weaponId: "w3",
    // Kettle
    setups: {
      S: { focus: "DPS M\xC1XIMO (SEMI)", description: "Foco em zerar o bloom e maximizar a cad\xEAncia de tiro.", modIds: ["m3", "ma3", "m11", "m28"] },
      A: { focus: "ESTABILIDADE TOTAL", description: "Rifle extremamente preciso e f\xE1cil de controlar.", modIds: ["mb3", "mv2", "m10b", "m26"] }
    }
  },
  {
    weaponId: "w-rattler",
    // Rattler
    setups: {
      S: { focus: "GLASS CANNON", description: "Cad\xEAncia insana com controle de bloom agressivo.", modIds: ["m3", "ma3", "m28"] },
      A: { focus: "CONTROLE E CONSIST\xCANCIA", description: "Mais est\xE1vel e menos punitivo no recuo.", modIds: ["m2", "ma3", "mp3"] }
    }
  },
  {
    weaponId: "w-arpeggio",
  ...
  },
  {
    ...
    // Bettina
    setups: {
      S: { focus: "DESTRUIDOR PESADO", description: "Dano massivo com cad\xEAncia aumentada.", modIds: ["m3", "ma3", "m28"] },
  ...
  },
  {
    ...
    setups: {
      ...
      A: { focus: "SMG CONTROLADA", description: "Vers\xE1til para curta e m\xE9dia dist\xE2ncia.", modIds: ["mb3", "m23", "m11", "m26"] }
    }
  },
  {
    weaponId: "w-vulcano",
    // Vulcano
    setups: {
      S: { focus: "DPS M\xC1XIMO", description: "Spam de shotgun semi-auto com spread fechado.", modIds: ["m6b", "mv3", "m17", "m28"] },
      A: { focus: "VULCANO EST\xC1VEL", description: "Maior controle no recuo entre disparos.", modIds: ["m6", "ma3", "m17", "mp3"] }
    }
  },
  {
    weaponId: "w1",
    // Ferro
    setups: {
      S: { focus: "PICK RIFLE AGRESSIVO", description: "ADS instant\xE2neo para punir peeks.", modIds: ["m4", "mv3", "m27"] },
      A: { focus: "H\xCDBRIDA PRECISA", description: "Follow-ups mais limpos e menor recuo.", modIds: ["m3", "mv3", "m26"] }
    }
  },
  {
    weaponId: "w7",
    // Renegade
    setups: {
      S: { focus: "DMR ALL-ROUNDER", description: "Aumenta velocidade do proj\xE9til e alcance.", modIds: ["m4", "m14", "m26"] },
      A: { focus: "DUELO PVP", description: "ADS r\xE1pido para trocas r\xE1pidas de tiro.", modIds: ["m3", "m14", "m27"] }
    }
  },
  {
    weaponId: "w2",
    // Stitcher
    setups: {
      S: { focus: "SMG META PVP", description: "Equil\xEDbrio perfeito entre DPS e controle.", modIds: ["m3", "mv3", "m11", "m26"] },
  ...
  },
  {
    ...
    setups: {
      ...
      A: { focus: "CONSISTENTE", description: "Hits confi\xE1veis a dist\xE2ncias maiores.", modIds: ["m6", "mv3", "m17", "m26"] }
    }
  },
  {
    weaponId: "w5",
    // Anvil
    setups: {
      S: { focus: "ANTI-ARC / AREA DAMAGE", description: "Usa o Anvil Splitter para dano em \xE1rea massivo.", modIds: ["m4", "m-anvilsplitter"] },
      A: { focus: "PRECISION PICK", description: "Dano de precis\xE3o em alvo \xFAnico.", modIds: ["m3", "m-anvilsplitter"] }
    }
  },
  {
    weaponId: "w8",
    // Venator
    setups: {
      S: { focus: "SNIPER AGRESSIVO", description: "Otimiza mira r\xE1pida e controle de recuo para duelos.", modIds: ["ma3", "m14"] },
      A: { focus: "SNIPER EST\xC1VEL", description: "Foco em precis\xE3o total e follow-up consistente.", modIds: ["m22", "m14"] }
    }
  },
  {
    weaponId: "w9",
    // Osprey
    setups: {
      S: { focus: "SNIPER META PICK", description: "Transi\xE7\xE3o r\xE1pida para ADS e alta velocidade de bala.", modIds: ["m4", "mv3", "m14", "m27"] },
      A: { focus: "SNIPER STEALTH", description: "Opera\xE7\xF5es silenciosas com recuo zero.", modIds: ["ms3", "mv3", "m14", "m26"] }
    }
  },
  {
    weaponId: "w10",
    // Torrente
    setups: {
      S: { focus: "SUPRESS\xC3O META", description: "Inunda o campo de batalha com balas.", modIds: ["m3", "m14", "m28"] },
      A: { focus: "TORRENTE LASER", description: "Fogo cont\xEDnuo extremamente preciso.", modIds: ["mb3", "m14", "mp3"] }
    }
  }
];
