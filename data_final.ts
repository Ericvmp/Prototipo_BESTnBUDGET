...
export const MATERIALS_DATA: Material[] = [
  ...
  },
  {
    ...
    rarity: 'RARE',
    icon: 'extension',
    imageUrl: 'https://arcraiders.wiki/w/images/3/3d/Complex_Gun_Parts.png',
...
export const MODS_DATA: Modification[] = [
  ...
  { id: 'm1', name: 'Compensator I', recycleInfo: [ { name: 'Metal Parts',
    ...
    purchasableFromCeleste: true, quantity: 2 }], imageUrl: '/images/items/Power_Rod.png' },
  ...
  { id: 'mb1', name: 'Muzzle Brake I', recycleInfo: [ { name: 'Metal Parts',
    ...
    purchasableFromCeleste: true, quantity: 3 }], imageUrl: '/images/items/Muzzle_Brake_III.png' },
  { id: 'mb2', name: 'Muzzle Brake II', recycleInfo: [ { name: 'Mechanical Components', stackSize: 10, quantity: 1 }, { name: 'Wires',
    ...
    purchasableFromCeleste: true, quantity: 5 }], imageUrl: '/images/items/Muzzle_Brake_III.png' },
  ...
  { id: 'm5', name: 'Shotgun Choke I', recycleInfo: [ { name: 'Metal Parts',
    ...
    purchasableFromCeleste: true, quantity: 2 }], imageUrl: '/images/items/Shotgun_Choke_III.png', weaponTypeCompatibility: ['SHOTGUN'] },
  { id: 'm6', name: 'Shotgun Choke II', recycleInfo: [ { name: 'Mechanical Components', stackSize: 10, quantity: 1 }, { name: 'Wires',
    ...
    purchasableFromCeleste: true, quantity: 4 }], imageUrl: '/images/items/Shotgun_Choke_III.png', weaponTypeCompatibility: ['SHOTGUN'] },
  ...
  { id: 'ms1', name: 'Silencer I', recycleInfo: [ { name: 'Mechanical Components', stackSize: 10, quantity: 1 }, { name: 'Wires',
    ...
    purchasableFromCeleste: true, quantity: 2 }], imageUrl: '/images/items/Silencer_II.png' },
  ...
  { id: 'ms3', name: 'Silencer III', recycleInfo: [ { name: 'Mod Components', stackSize: 5, quantity: 1 }, { name: 'Wires',
    ...
    purchasableFromCeleste: true, quantity: 6 }], imageUrl: '/images/items/Silencer_II.png' },
  ...
  { id: 'm12', name: 'Extended Medium Mag I', recycleInfo: [ { name: 'Plastic Parts',
    ...
    purchasableFromCeleste: true, quantity: 2 }], imageUrl: '/images/items/Extended_Medium_Mag_II.png', ammoCompatibility: 'MEDIUM' },
  ...
  { id: 'msm1', name: 'Extended Shotgun Mag I', recycleInfo: [ { name: 'Plastic Parts',
    ...
    purchasableFromCeleste: true, quantity: 1 }], imageUrl: '/images/items/Extended_Shotgun_Mag_III.png', ammoCompatibility: 'SHOTGUN' },
  { id: 'msm2', name: 'Extended Shotgun Mag II', recycleInfo: [ { name: 'Mechanical Components', stackSize: 10, quantity: 1 }, { name: 'Steel Spring',
    ...
    purchasableFromCeleste: true, quantity: 2 }], imageUrl: '/images/items/Extended_Shotgun_Mag_III.png', ammoCompatibility: 'SHOTGUN' },
  ...
  { id: 'm18', name: 'Angled Grip I', recycleInfo: [ { name: 'Plastic Parts',
    ...
    purchasableFromCeleste: true, quantity: 2 }], imageUrl: '/images/items/Angled_Grip_III.png' },
  { id: 'm19', name: 'Angled Grip II', recycleInfo: [ { name: 'Mechanical Components', stackSize: 10, quantity: 1 }, { name: 'Duct Tape',
    ...
    purchasableFromCeleste: true, quantity: 4 }], imageUrl: '/images/items/Angled_Grip_III.png' },
  ...
  { id: 'mv1', name: 'Vertical Grip I', recycleInfo: [ { name: 'Plastic Parts',
    ...
    purchasableFromCeleste: true, quantity: 6 }, { name: 'Duct Tape',
    purchasableFromCeleste: true, quantity: 2 }], imageUrl: '/images/items/Vertical_Grip_II.png' },
  ...
  { id: 'm24', name: 'Stable Stock I', recycleInfo: [ { name: 'Rubber Parts',
    ...
    purchasableFromCeleste: true, quantity: 2 }], imageUrl: '/images/items/Stable_Stock_III.png' },
  { id: 'm25', name: 'Stable Stock II', recycleInfo: [ { name: 'Mechanical Components', stackSize: 10, quantity: 1 }, { name: 'Duct Tape',
    ...
    purchasableFromCeleste: true, quantity: 4 }], imageUrl: '/images/items/Stable_Stock_III.png' },
  ...
  { id: 'mp3', name: 'Padded Stock III', recycleInfo: [{ name: 'Mod Components', quantity: 1 }], salvageInfo: [{ name: 'Mechanical Components', quantity: 1 }], category: 'STOCK', rarity: 'RARE', icon: 'format_underlined', tier: 3, description: '20% Reduced Base Dispersion, 20% Reduced Vertical/Horizontal Recoil, 50% Reduced ADS Speed', materials: [{ name: "Mod Components", quantity: 2 }, { name: 'Duct Tape',
    purchasableFromCeleste: true, quantity: 6 }], imageUrl: '/images/items/Stable_Stock_III.png' },
  ...
  { id: 'm-shotgunsilencer', name: 'Shotgun Silencer', recycleInfo: [ { name: 'Mod Components', stackSize: 5, quantity: 1 }, { name: 'Wires',
    ...
    purchasableFromCeleste: true, quantity: 8 }], imageUrl: '/images/items/Silencer_II.png', weaponTypeCompatibility: ['SHOTGUN'] },
];
...
export const THROWABLES_DATA: Throwable[] = [
  ...
  },
  {
    ...
    purchasableFromCeleste: true, stackSize: 50, quantity: 3 } ], rarity: 'RARE', icon: 'cloud', imageUrl: '/images/items/Plastic_Parts.png', stackSize: 5,
    description: '', category: 'THROWABLES',
  ...
  },
  {
    ...
    purchasableFromCeleste: true, stackSize: 15, quantity: 1 } ], rarity: 'RARE', icon: 'settings_input_antenna', imageUrl: '/images/items/Electrical_Components.png', stackSize: 3,
    description: '', category: 'THROWABLES',
  ...
  },
  {
    ...
    purchasableFromCeleste: true, stackSize: 15, quantity: 2 } ], rarity: 'RARE', icon: 'trip_origin', imageUrl: '/images/items/Electrical_Components.png', stackSize: 3,
    description: '', category: 'THROWABLES',
  ...
  { id: 't-lil-smoke', name: "Li'l Smoke Grenade", rarity: 'COMMON', icon: 'cloud', imageUrl: "/images/items/Electrical_Components.png", category: 'THROWABLES', description: 'A smaller smoke grenade that creates a brief, compact smoke screen.', stackSize: 5,
  ...
  { id: 't-gas-trap', name: 'Gas Grenade Trap', rarity: 'UNCOMMON', icon: 'blur_circular', imageUrl: "/images/items/Wires.png", category: 'THROWABLES', description: 'A laser tripwire trap that releases toxic gas when triggered.', stackSize: 3,
  ...
  { id: 't-lure-trap', name: 'Lure Grenade Trap', rarity: 'COMMON', icon: 'radar', imageUrl: "/images/items/Electrical_Components.png", category: 'THROWABLES', description: 'A laser tripwire trap that triggers a lure signal to distract ARC.', stackSize: 3,
  ...
  { id: 't-smoke-trap', name: 'Smoke Grenade Trap', rarity: 'COMMON', icon: 'cloud', imageUrl: "/images/items/Wires.png", category: 'THROWABLES', description: 'A laser tripwire trap that deploys a smoke screen when triggered.', stackSize: 3,
  ...
  { id: 't-door-blocker', name: 'Door Blocker', rarity: 'COMMON', icon: 'door_front', imageUrl: "/images/items/Metal_Parts.png", category: 'QUICK USE', description: 'Jams a door shut so it cannot be opened from either side.', stackSize: 3,
  ...
  { id: 't-binoculars', name: 'Binoculars', rarity: 'UNCOMMON', icon: 'travel_explore', imageUrl: "/images/items/Metal_Parts.png", category: 'QUICK USE', description: 'Long-range optical device that lets you scout at great distances.', stackSize: 1,
...
export const LOOT_DATA: LootCategory[] = [
  // --- NON-CRAFTABLE ITEMS FIRST (A-Z) ---
  {
    id: 'loot-arc-alloy',
    material: 'ARC Alloy',
    materialImageUrl: "/images/items/Damaged_Leaper_Pulse_Unit.png",
  ...
  },
  {
    ...
    materialImageUrl: "/images/items/Angled_Grip_III.png",
  ...
  },
  {
    ...
    material: 'Chemicals',
    purchasableFromCeleste: true,
    materialImageUrl: "/images/items/Vita_Shot.png",
  ...
  },
  {
    ...
    purchasableFromCeleste: true,
    materialImageUrl: "/images/items/Toaster.png",
    ...
    purchasableFromCeleste: true, quantity: 1, imageUrl: '/images/items/Processor.png' },
      ...
      { name: 'ARC Synthetic Resin', quantity: 14, imageUrl: '/images/items/Electrical_Components.png' },
      ...
      { name: 'Angled Grip I', quantity: 6, imageUrl: '/images/items/Angled_Grip_III.png' },
    ],
  },

  {
    ...
    material: 'Magnet',
    purchasableFromCeleste: true,
    materialImageUrl: "/images/items/Microscope.png",
  ...
  },
  {
    ...
    materialImageUrl: "/images/items/Anvil_Splitter.png",
...

  {
    ...
    purchasableFromCeleste: true,
    materialImageUrl: "/images/items/Ruined_Accordion.png",
  ...
  },
  {
    ...
    material: 'Wires',
    purchasableFromCeleste: true,
    materialImageUrl: "/images/items/Portable_TV.png",
  ...
  },
  {
    ...
    materialImageUrl: "/images/items/Fried_Motherboard.png",
  ...
  },
  {
    ...
    purchasableFromCeleste: true,
    materialImageUrl: "/images/items/Anvil.png",
    ...
    sources: [
      ...
      { name: 'Complex Gun Parts',
    purchasableFromCeleste: true, quantity: 3, imageUrl: 'https://arcraiders.wiki/w/images/3/3d/Complex_Gun_Parts.png' },
  ...
  },
  {
    ...
    materialImageUrl: "/images/items/Wolfpack.png",
  ...
  },
  {
    ...
    material: 'Fabric',
    purchasableFromCeleste: true,
    materialImageUrl: "/images/items/Herbal_Bandage.png",
  ...
  },
  {
    ...
    materialImageUrl: "/images/items/Sterilized_Bandage.png",
  ...
  },
  {
    ...
    material: 'Moss',
    purchasableFromCeleste: true,
    materialImageUrl: "/images/items/Defibrillator.png",
  ...
  },
  {
    ...
    material: 'Battery',
    purchasableFromCeleste: true,
    materialImageUrl: "/images/items/Jolt_Mine.png",
  ...
  },
  {
    ...
    purchasableFromCeleste: true,
    materialImageUrl: "/images/items/Bombardier_Cell.png",
  ...
  },
  {
    ...
    materialImageUrl: "/images/items/Heavy_Fuze_Grenade.png",
  ...
  },
  {
    ...
    purchasableFromCeleste: true,
    materialImageUrl: "/images/items/Trailblazer.png",
  ...
  },
  {
    ...
    materialImageUrl: "/images/items/Deadline.png",
  ...
  },
  {
    ...
    materialImageUrl: "/images/items/Ruined_Riot_Shield.png",
  ...
  },
  {
    ...
    material: 'Rope',
    purchasableFromCeleste: true,
    materialImageUrl: "/images/items/Zipline.png",
  ...
  },
  {
    ...
    purchasableFromCeleste: true,
    materialImageUrl: "/images/items/Headphones.png",
